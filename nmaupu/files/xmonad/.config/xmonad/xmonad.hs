...
myWorkspaces = take 8 $ map show [1 ..]
numLockKey = mod2Mask
...
rofiProg = "LC_ALL=C rofi -modi run -theme sidebar -show"
rofiClipboard = "LC_ALL=C rofi -modi \"clipboard:greenclip print\" -theme solarized_alternate -show clipboard -run-command '{cmd}'"
